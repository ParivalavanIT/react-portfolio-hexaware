const gradientMapping = {
  ...
  black: "linear-gradient(hsl(223, 10%, 10%), hsl(208, 10%, 10%))",
    ...
    >
      {items.map((item, index) => (
        ...
        >
          ...
          <span className="absolute top-full  text-white left-0 right-0 text-center whitespace-nowrap leading-[2] text-base opacity-0 transition-[opacity,transform] duration-300 ease-[cubic-bezier(0.83,0,0.17,1)] translate-y-0 group-hover:opacity-100 group-hover:[transform:translateY(20%)]">
            {item.label}
          </span>
        </button>
      ))}
